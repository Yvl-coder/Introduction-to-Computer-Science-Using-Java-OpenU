/**
 * This class performs operations on a point in the cartesian system.
 *
...
public class Point {
    private int _x; // the value of the coordinate x of a point
    private int _y; // the value of the coordinate y of a point
     ...
     * 
     * @other the point to be compared with the current point
